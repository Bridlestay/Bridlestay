...
CREATE INDEX IF NOT EXISTS idx_property_questions_property ON property_questions(property_id);
CREATE INDEX IF NOT EXISTS idx_property_questions_asker ON property_questions(asker_id);
