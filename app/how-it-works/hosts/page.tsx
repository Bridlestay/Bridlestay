        ...
        <div className="container mx-auto px-4 py-12 max-w-5xl">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="font-serif text-5xl font-bold mb-4">
              How BridleStay Works for Hosts
            </h1>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
                          <li>Guest books and pays through BridleStay</li>
                      ...
                      <div className="p-4 bg-blue-50 dark:bg-blue-950 rounded-lg border border-blue-200 dark:border-blue-800">
                        ...
                        <ul className="space-y-1 text-sm text-muted-foreground">
                          ...
                          <li>BridleStay charges just <strong>2.5%</strong> + VAT to maintain the platform</li>
                      ...
                      <div className="p-4 bg-green-50 dark:bg-green-950 rounded-lg border border-green-200 dark:border-green-800">
                        ...
                        <p className="text-sm text-muted-foreground">
                          ...
                          BridleStay never sees or stores your bank details.
                        </p>
                      </div>
          ...
          <Card className="bg-primary text-primary-foreground">
            <CardContent className="pt-12 pb-12 text-center">
              ...
              <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
                Join BridleStay and turn your equestrian property into a thriving hospitality business
              </p>
