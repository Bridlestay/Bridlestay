        ...
        <div className="prose prose-lg">
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Cantra&apos;s slavery and human trafficking statement for the financial year ending 2024.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              Cantra operates an online marketplace connecting equestrian property hosts with guests
