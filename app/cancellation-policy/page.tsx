        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p>
                Unless otherwise specified by the host, all bookings follow BridleStay's Standard Cancellation Policy.
              </p>
            ...
            <section>
              ...
              <p>
                In rare cases, BridleStay may provide refunds outside the standard policy for extenuating circumstances:
              </p>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm text-yellow-900 dark:text-yellow-100">
                      ...
                      <p>
                        ...
                        BridleStay reviews each case individually. Approval is not guaranteed.
                      </p>
                    </div>
                  </div>
                </CardContent>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li><strong>Help rebooking:</strong> BridleStay will assist in finding alternative accommodation</li>
              </ul>
              ...
              <p className="mt-4 text-sm italic bg-muted p-3 rounded-lg">
                ...
                may be waived at BridleStay's discretion with proper documentation.
              </p>
            </section>
            ...
            <section>
              ...
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li><strong>Contact BridleStay support</strong> within 24 hours of check-in</li>
              ...
              <p>
                ...
                contact BridleStay immediately. We may authorize alternative accommodation and a full refund.
              </p>
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>BridleStay approves the early checkout</li>
            ...
            <section>
              ...
              <ol className="list-decimal pl-6 space-y-2">
                <li>Log in to your BridleStay account</li>
            ...
            <section>
              ...
              <div className="bg-muted p-4 rounded-lg mt-3 space-y-1 text-sm">
                <p><strong>Email:</strong> support@bridlestay.co.uk</p>
            ...
            <section className="border-t pt-6 mt-8">
              <p className="text-sm text-muted-foreground italic">
                ...
                BridleStay reserves the right to modify this policy at any time. Changes will be communicated to active users.
              </p>
            </section>
          </div>
        </div>
