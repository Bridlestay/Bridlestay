...
export const metadata: Metadata = {
  title: "padoq News | Updates, Features & Community Stories",
  description: "Stay up to date with the latest padoq updates, new features, and community stories",
};
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium">
                          {featuredPost.author?.name || "padoq Team"}
                        </p>
