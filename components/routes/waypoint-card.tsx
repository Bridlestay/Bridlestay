...
export function WaypointCard({ waypoint, distanceFromStart, onClick }: WaypointCardProps) {
  const iconConfig = ICON_MAP[waypoint.icon_type] || ICON_MAP.other;
      ...
      <div className="flex gap-4 p-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2 mb-1">
            <h4 className="font-semibold text-base leading-tight">{waypoint.name}</h4>
