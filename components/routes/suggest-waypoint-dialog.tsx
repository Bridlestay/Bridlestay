...
export function SuggestWaypointDialog({
  open,
  onOpenChange,
  routeId,
  routeGeometry,
  onSuggestionSubmitted,
}: SuggestWaypointDialogProps) {
  ...
  const handleSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      const res = await fetch(`/api/routes/${routeId}/waypoint-suggestions`, {
        method: "POST",
      ...
      if (res.ok) {
        onSuggestionSubmitted();
        onOpenChange(false);
        toast.success("Waypoint suggestion submitted! The route owner will review it.");
      } else {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Suggest a Waypoint</DialogTitle>
          <DialogDescription>
            Suggest a useful waypoint for the route owner to review and approve.
          </DialogDescription>
        </DialogHeader>
