...
// Horse icon component (alias for semantic naming)
export function HorseIcon({ className = "h-6 w-6" }: HorseshoeIconProps) {
  return (
    <svg
...
// Export the same component with original name for backwards compatibility
export const HorseshoeIcon = HorseIcon;
